...
function PostPreview (props: PostPreviewProps) {
  const { post, fetchSinglePost, loading, publishPost} = useSinglePost()
  ...
  function navigateToEditPostView() {
   window.location.pathname = `/post/editar/${props.postId}`
  }


  useEffect(() => {
    fetchSinglePost(props.postId)
  },[fetchSinglePost, props.postId])
    ...
    <PostPreviewHeading>
      ...
      <PostPreviewActions>
        ...
        <Button
          ...
          label={'Editar'}
          disabled={post.published}
          onClick={navigateToEditPostView}
        />
      </PostPreviewActions>
    </PostPreviewHeading>
    <PostPreviewImage
